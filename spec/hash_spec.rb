...
describe 'Test hashing requirements' do
  ...
  describe 'Test regular hashing' do
    it 'should find the same hash for identical cards' do
      @cc1.hash.wont_be_nil
      @cc2.hash.wont_be_nil
  ...
  describe 'Test cryptographic hashing' do
    ...
    it 'should not produce the same regular vs. cryptographic hash' do
      ...
      @cc2.hash_secure.wont_equal @cc2.hash
      @cc3.hash_secure.wont_equal @cc3.hash
    end
  end
end
